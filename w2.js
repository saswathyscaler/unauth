...
export const WeatherWidget = () => {
  ...
  if (!loading && !error) selectedDay = data.weatherResponse.list[selectedDayIdx || 0];
      ...
      <div className="px-2 overflow-y-auto bg-white border border-gray-200 rounded-sm shadow-inner sm:px-4 py-3" style={{ height: CONTAINER_HEIGHT, width: CONTAINER_WIDTH }}>
        ...
        {!!selectedDay && (
          <div className="flex flex-col justify-between h-full space-y-2">
            ...
            <FiveDayForecast list={data.weatherResponse.list|| []} setSelectedDayIdx={setSelectedDayIdx} selectedDayIdx={selectedDayIdx} />
          </div>
        )}
      </div>
    </div>
